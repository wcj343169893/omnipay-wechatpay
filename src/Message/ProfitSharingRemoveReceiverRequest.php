 ...
 * @link    https://pay.weixin.qq.com/wiki/doc/api/allocation.php?chapter=27_4&index=5
 * @method  BaseAbstractRequest send()
 */
class ProfitSharingRemoveReceiverRequest extends BaseAbstractRequest
{
    protected $endpoint = 'https://api.mch.weixin.qq.com/pay/profitsharingremovereceiver';
