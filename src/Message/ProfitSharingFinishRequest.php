 ...
 * @link    https://pay.weixin.qq.com/wiki/doc/api/allocation.php?chapter=27_5&index=6
 * @method  CreateMicroOrderResponse send()
 */
class ProfitSharingFinishRequest extends CreateOrderRequest
{
    protected $endpoint = 'https://api.mch.weixin.qq.com/secapi/pay/profitsharingfinish';
